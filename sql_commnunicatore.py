...
# --- Database schema classes (copied from main1.py) ---
@dataclass
class ColumnInfo:
    table_name: str
    column_name: str
...
class EnhancedDatabaseAnalyzer:
    ...
    def is_schema_analyzed(self) -> bool:
        ...
        try:
            ...
            return is_fresh and db_matches
        except Exception as e:
...
class AdvancedTextToSQLEngine:
    ...
    def stream_natural_response_sync(self, query: str, result: Dict[str, Any]):
        """Synchronous streaming natural response using OpenRouter"""
    ...
    while True:
        try:
            ...
            if result['success']:
                ...
                print(f"📊 Found {result['row_count']} results in {exec_time:.3f}s")
